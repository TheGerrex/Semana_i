/**
 Stencil Browser Compiler - stencil-browser.js v0.0.0-dev.20191023015347
...
const compilerBuild = {
    buildId: '20191023015347',
    vermoji: '💎',
    stencilVersion: '0.0.0-dev.20191023015347',
...
const IS_WEB_WORKER_ENV = (typeof self !== 'undefined' && typeof self.importScripts === 'function' && typeof XMLHttpRequest !== 'undefined' && typeof location !== 'undefined');
...
const createWebWorkerMainController = (maxConcurrentWorkers) => {
    let msgIds = 0;
