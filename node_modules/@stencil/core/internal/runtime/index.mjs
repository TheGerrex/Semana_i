...
import { win, getHostRef, styles, supportsConstructibleStylesheets, doc, plt, supportsShadowDom, isMemberInElement, consoleError, nextTick, writeTask, supportsListenerOptions, loadModule, registerHost, Context, readTask } from '@stencil/core/internal/platform';
let i = 0;
let scopeId;
let contentRef;
let hostTagName;
...
export { Host, attachShadow, bootstrapLazy, connectedCallback, createEvent, defineCustomElement, disconnectedCallback, getAssetPath, getConnect, getContext, getElement, getMode, getValue, h, insertVdomAnnotations, parsePropertyValue, postUpdateComponent, proxyComponent, proxyCustomElement, proxyNative, renderVdom, setMode, setValue };
